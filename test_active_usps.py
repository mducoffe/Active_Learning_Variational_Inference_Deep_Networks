...
# @date 10/02/2016 #
####################
from load_data import load_dataset_usps
from training_usps import build_training, training_committee
import numpy as np
import theano
...
def training(repo, learning_rate, batch_size, filenames, option, record_repo=None, record_filename=None, nb_to_query=1):
	...
	print 'LOAD DATA'
	filename = "usps_resampled.mat"
	(x_train, y_train), (x_valid, y_valid), (x_test, y_test) = load_dataset_usps(repo, filename)
	...
	for epoch in range(epochs):
		...
		try:
			...
			if done and increment==0:
				...
				if option=="random":
					n_train_batches+=1
					if (1.*n_train_batches/n_train*100)>99.:
						return
				else:
					...
					if (1.*n_train_batches/n_train*100)>30.:
						return
...
if __name__=="__main__":
	...
	repo="/home/ducoffe/Documents/Code/datasets/usps/usps_resampled"
	#repo = "/home/ducoffe/Documents/Code/datasets/usps"
